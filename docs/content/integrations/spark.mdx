...
If you want to use this approach to run a Spark job on Databricks, <PyObject module='dagster_databricks' object='create_databricks_run_now_op' /> or <PyObject module='dagster_databricks' object='create_databricks_submit_run_op' /> help create ops that submit a Spark job using the Databricks REST API.
