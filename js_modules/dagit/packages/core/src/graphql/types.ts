...
export const buildConcurrencyLimit = (
  ...
  return {
    __typename: 'ConcurrencyLimit',
    activeRunIds:
      overrides && overrides.hasOwnProperty('activeRunIds') ? overrides.activeRunIds! : ['et'],
    concurrencyKey:
  ...
  return {
    ...
    concurrencyLimits:
      overrides && overrides.hasOwnProperty('concurrencyLimits')
        ...
        : [
            relationshipsToOmit.has('ConcurrencyLimit')
              ? ({} as ConcurrencyLimit)
              : buildConcurrencyLimit({}, relationshipsToOmit),
          ],
    daemonHealth:
